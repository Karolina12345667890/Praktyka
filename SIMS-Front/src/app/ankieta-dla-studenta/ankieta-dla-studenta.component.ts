...
export class AnkietaDlaStudentaComponent implements OnInit {
  ...
  get studentName() {
    return this.ankietaStudentForm.get('studentName');
  }

  get studentSurname() {
    return this.ankietaStudentForm.get('studentSurname');
  }

  get studentSpecialization() {
    return this.ankietaStudentForm.get('studentSpecialization');
  }

  get instytutionType() {
    return this.ankietaStudentForm.get('instytutionType');
  }

  get companyNameAndLocation() {
    return this.ankietaStudentForm.get('companyNameAndLocation');
  }

  get periodFrom() {
    return this.ankietaStudentForm.get('periodFrom');
  }

  get periodTo() {
    return this.ankietaStudentForm.get('periodTo');
  }
